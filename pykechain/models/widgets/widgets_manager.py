...
from pykechain.models.input_checks import (
    check_base, check_enum, check_list_of_text, check_text,
    check_type,
)
...
from pykechain.models.widgets.enums import (
    AssociatedObjectId, DashboardWidgetShowScopes,
...
from pykechain.models.widgets.helpers import (
    TITLE_TYPING, _check_excluded_propmodels,
    _check_prefilters,
...
class WidgetsManager(Iterable):
        ...
        **kwargs
        ...
        for nr, input_dict in enumerate(activities):
            if not set(input_dict.keys()).issubset(set_of_expected_keys):
                raise IllegalArgumentError(
                    "Found unexpected key in activities. Only keys allowed are: {}".
        ...
        meta.update(
            {
                ...
                MetaWidget.SHOW_LOG: True if download_log else check_type(
    ...
    def add_scope_widget(
        ...
        **kwargs
        ...
        for button_setting in [
            add, edit, delete, clone, emphasize_add, emphasize_clone, emphasize_edit,
            emphasize_delete,
        ]:
    ...
    def add_dashboard_widget(
        ...
        source_scopes: Optional[
            DashboardWidgetSourceScopes] = DashboardWidgetSourceScopes.CURRENT_SCOPE,
        ...
        meta.update(
            {
                ...
                MetaWidget.SHOW_OPEN_VS_CLOSED_TASKS: check_type(
                    show_open_vs_closed_tasks, bool,
    ...
    def add_tasks_widget(
        ...
        **kwargs
        ...
        meta.update(
            {
                MetaWidget.VISIBLE_ADD_BUTTON: check_type(
                    add, bool, "add"
                ) if parent_activity else None,
